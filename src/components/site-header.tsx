...
/**
 * En-tête du site : nom commercial, navigation principale et bouton de devis.
 * Le menu mobile utilise <details>/<summary> pour rester sans JavaScript.
 */
      ...
      <Container className="flex h-16 items-center justify-between gap-4">
        ...
        <details className="relative md:hidden">
          ...
          <div className="absolute right-0 z-10 mt-2 w-56 rounded-lg border border-border bg-background p-2 shadow-lg">
            ...
            <Link
              href="/contact"
              className="mt-1 block rounded-md bg-brand-600 px-3 py-2 text-center text-sm font-medium text-white hover:bg-brand-700"
            >
              Demander un devis
            </Link>
          </div>
